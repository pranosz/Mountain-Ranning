    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            if( instance.options.selectAll ) {
                optionsList.before('<button class="ms-selectall global">' + instance.options.texts.selectAll + '</button>');
            }
                ...
                if( thisOption.hasOwnProperty('options') ) {
                    ...
                    if( appendContainer ) {
                        ...
                        if( instance.options.selectGroup ) {
                            container.append('<button class="ms-selectall">' + instance.options.texts.selectAll + '</button>')
                        }
